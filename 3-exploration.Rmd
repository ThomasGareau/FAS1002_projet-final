...
Flagrante en terme de de nombre de personnes vaccinées,

```{r}
ggplot(df_continent) +
 aes(x = continent, weight = people_vaccinated) +
 geom_bar(fill = "#112446") +
 labs(x = "Continent", y = "Nombre d'individus (densité)", title = "Nombre d'individus vaccinés par continent") +
 theme_minimal()
...
```{r}
ggplot(df_continent) +
 aes(x = continent, weight = total_boosters) +
 geom_bar(fill = "#112446") +
 labs(x = "Continent", 
 y = "Nombre de \"boosters\"", title = "Nombre de \"boosters\" reçus par continent") +
 theme_minimal()
```
